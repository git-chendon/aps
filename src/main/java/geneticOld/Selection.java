...
//        double[] fit = fitness.fitness(chromGroup, durationTime); //找到每个个体适应度
//        double[][] sortFit = selectSort(fit); //排序每个个体适应度得到 （适应度--个体）映射数组
...
//    public double[][] selectionSingle(List<int[][]> chromGroup, int[][] durationTime) {
//        Fitness fitness = new Fitness();
//        double[] fit = fitness.fitness(chromGroup, durationTime);
...
//
//        //计算各种群的适应度，并排序输出
//        double[][] sortFitP = selectionSingle(P, durationTime);
//        double[][] sortFitC1 = selectionSingle(C1, durationTime);
//        double[][] sortFitC2 = selectionSingle(C2, durationTime);
//
//        //筛选出各种群中最优的，形成新的种群
//        int tag = 0;
//        int tagP = 0;
...
//            }
//            if (minIndex != i) {
//                double temp0 = result[0][i];
//                double temp1 = result[1][i];
